...
const openSignUps = document.querySelectorAll('.openSignUpOn');
...
// NOW WE DISPLAY THE INPUTS FOR THE OPEN SIGN UP IF IT'S TRUE ****************************************************
...
const openSignUp = document.getElementsByName('tournament_open_signup_1');
const closedSignUp = document.getElementsByName('tournament_open_signup_0');
