...
window.addEventListener("load", (event) => {
    ...
    $(document).ready(function() { // Une fois que le document (base.html.twig) HTML/CSS a bien été complètement chargé...
        ...
        $('.add-another-collection-widget').click(function (e) {
            ...
            // par un numéro unique au sein de la collection de "playerRosters" : ce numéro sera la valeur du compteur
            // courant (équivalent à l'index du prochain champ, en cours d'ajout).
            // Au final, l'attribut ressemblera à "roster[playerRosters][n°]"
            newWidget = newWidget.replace(/__name__/g, counter)
            
            // Ajout également des attributs personnalisés "class" et "value", qui n'apparaissent pas dans le prototype original 
            newWidget = newWidget.replace(/><input type="hidden"/, ' class="borders"><input type="hidden" value="'+roster+'"')
        ...
        // remove-roster.js : fonction permettant de demander la confirmation de suppression d'un joueur
        $('.remove-roster-confirm').on('click', function(e) {
        ...
        // remove-playerRoster.js : fonction permettant de demander la confirmation de suppression d'un playerRoster
        $('.remove-playerRoster-confirm').on('click', function(e) {
            ...
            showModalConfirm(id, href, "Confirmation de suppression d'un roster")
