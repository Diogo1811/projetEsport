 ...
 */
final class Version20231120130514 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE editor CHANGE country country VARCHAR(2) NOT NULL');
        $this->addSql('ALTER TABLE player ADD country VARCHAR(2) NOT NULL, DROP countries');
        $this->addSql('ALTER TABLE team CHANGE country country VARCHAR(2) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE editor CHANGE country country VARCHAR(5) NOT NULL');
        $this->addSql('ALTER TABLE player ADD countries JSON NOT NULL, DROP country');
        $this->addSql('ALTER TABLE team CHANGE country country VARCHAR(5) NOT NULL');
    }
}
