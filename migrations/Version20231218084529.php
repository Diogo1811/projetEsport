 ...
 */
final class Version20231218084529 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE player CHANGE last_name last_name VARCHAR(100) DEFAULT NULL, CHANGE firstname firstname VARCHAR(100) DEFAULT NULL');
        $this->addSql('ALTER TABLE team CHANGE address address VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team CHANGE address address VARCHAR(50) DEFAULT NULL');
        $this->addSql('ALTER TABLE player CHANGE last_name last_name VARCHAR(100) NOT NULL, CHANGE firstname firstname VARCHAR(100) NOT NULL');
    }
}
